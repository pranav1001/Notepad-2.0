import keyboard  #use of mscvrt to get character from user on real time without pressing enter

train_data = 'wonderland.txt'
...
while(c != b'\r'): #stop when user preses enter
    if(c == b'\t'): #if previous character was tab, then after autocompletion dont wait for user inpput.. just show suggestion
        c = b' '
